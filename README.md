...
You've spent hundreds of hours in Minecraft. It's a beautiful game, a digital canvas where you and your friends mine, craft, and bring incredible ideas to life, block by block. Maybe you've built a sprawling megabase, a complex redstone world eater, or even monumental cities that took months, years, of dedication. How would you feel if you logged into your server one day, and all of it was gone? Lavacasted to bits, the TNT craters leaving your world in an irreparable state. All that hard work, destroyed by players who are now sharing screenshots of your ruined base for clout, and laughing at your loss.

Born out of a Computer Science side project at the University of Texas at Austin, **CobbleGuard** has grown far beyond its academic roots. As word spread, other undergrad and grad students from various universities joined the project, driven by a shared history of players who grew up during the golden age of Minecraft, spending their middle school years watching YouTube Let’s Plays and building their first LAN worlds with school friends. Many of those same players went on to pursue careers in computer science and engineering, and are now using those technical skills to ensure the digital sandbox we loved as kids remains a safe, creative space for the next generation. We use our platform to teach the community about basic whitelisting and server security. 
...
On a cracked (offline-mode: true) server, any name can be faked, so nothing can be verified. The only accounts we use are CobbleGuard, Server_Protector, Whitelist_Check, and PutOnWhitelist. These can only be confirmed to be us if your server is not offline-mode.
