...
On a cracked (offline-mode: true) server, any name can be faked, so nothing can be verified. On premium servers, some of the player names we use are CobbleGuard, Server_Protector, Whitelist_Check, PutOnWhitelist
